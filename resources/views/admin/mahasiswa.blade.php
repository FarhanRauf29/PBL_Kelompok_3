      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            ...
            <div class="col-lg-12">
              <div class="block">
                <div class="title"><strong>Mahasiswa</strong></div>
                <div class="block-body">
                  <form class="form-horizontal" action="{{url('add_mahasiswa')}}" method="post">
                    ...
                    <div class="line"></div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <select name="prodi" class="form-control mb-3 mb-3">
